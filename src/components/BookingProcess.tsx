  ...
  const steps = [
    {
      ...
      description: "Sélectionnez le moment qui vous convient le mieux pour votre rituel RE·GEN.",
    },
    {
      id: 2,
      number: "02",
      ...
      description: "Partagez-nous vos besoins capillaires pour que nous préparions votre protocole personnalisé.",
    },
    {
      id: 3,
      number: "03",
      ...
      description: "Confirmez votre réservation avec l'acompte. Nos équipes vous recontactent sous 24h.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-body-base text-neutral-700 max-w-3xl mx-auto leading-relaxed font-body">
              En quelques clics, planifiez votre rituel RE·GEN.<br />
              Nos équipes vous recontactent sous 24h pour confirmer votre rendez-vous.
            </p>
          </div>
            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="mt-6 whitespace-pre-line font-display text-2xl leading-tight text-neutral-900 text-center">
                    {step.title}
                  </h3>
                  ...
                  {/* Description */}
                  <p className="mt-4 text-sm/6 text-neutral-700 text-center">
                    {step.description}
                  </p>
          ...
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-body-base text-neutral-900/80 font-body leading-relaxed">
              Le jour J, une experte RE·GEN se déplace chez vous avec tout le matériel nécessaire, et crée votre formule sur mesure.
            </p>
          </div>
        </div>
      </div>
